...
public class Main {
 ...
 //       sendRequest(snmp, createGetNextPdu(), target);
  ...
  //      System.out.println(snmpCpu.getCpuLoads()+"%");
        Flow flow = new Flow();
        flow.getFlow("192.168.2.128");
  //      target.setCommunity(new OctetString("public"));
...
/*        CommunityTarget broadcastTarget = new CommunityTarget();
        ...
        broadcastTarget.setAddress(new UdpAddress("192.168.2.255/161"));
    ...
    private static PDU createGetPdu() {
        ...
        pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.2.2.1.10.1")));
        pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.2.2.1.10.2")));
        pdu.add(new VariableBinding(new OID(".1.3.6.1.2.1.2.2.1.16.1")));
        pdu.add(new VariableBinding(new OID(".1.3.6.1.2.1.2.2.1.16.2")));
